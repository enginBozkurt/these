...
(cl:in-package ouster_driver-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <PacketMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PacketMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ouster_driver-msg:<PacketMsg> is deprecated: use ouster_driver-msg:PacketMsg instead.")))

(cl:ensure-generic-function 'buf-val :lambda-list '(m))
(cl:defmethod buf-val ((m <PacketMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ouster_driver-msg:buf-val is deprecated.  Use ouster_driver-msg:buf instead.")
  (buf m))

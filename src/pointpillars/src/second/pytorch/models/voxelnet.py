...
from second.pytorch.models.cospointpillars import cosPillarFeatureNet,cosPillarFeatureNet_mask
...
class VoxelNet(nn.Module):
    def __init__(self,
        ...
        ####new#####
        self.vfe_class_name = vfe_class_name
        ...
        vfe_class_dict = {
            ...
            "cosPillarFeatureNet": cosPillarFeatureNet,
            "cosPillarFeatureNet_mask": cosPillarFeatureNet_mask
        }
        ...
        elif vfe_class_name == "cosPillarFeatureNet":
            self.voxel_feature_extractor = vfe_class(
                num_input_features -1,
                use_norm,
                num_filters=vfe_num_filters,
        ...
        elif vfe_class_name == "cosPillarFeatureNet_mask":
            self.voxel_feature_extractor = vfe_class(
                num_input_features -1,
                use_norm,
                num_filters=vfe_num_filters,
    ...
    def forward(self, example):
        ...
        # coors: [num_voxels, 4]
        print(self.vfe_class_name)
        if self.vfe_class_name == "cosPillarFeatureNet" or self.vfe_class_name == "cosPillarFeatureNet_mask":
            voxel_features, theta = self.voxel_feature_extractor(voxels, num_points, coors)
        ...
        for box_preds, cls_preds, dir_preds, rect, Trv2c, P2, img_idx, a_mask in zip(
            ...
            if selected_boxes is not None:
                ...
                if self._use_direction_classifier:
                    ...
                    opp_labels = (box_preds[..., -1] > 0).byte() ^ dir_labels.byte()

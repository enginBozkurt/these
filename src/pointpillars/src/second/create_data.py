...
def create_kitti_info_file2(data_path,
                           save_path=None,
                           create_trainval=False,
                           relative_path=True):
    train_img_ids = _read_imageset_file("./data/ImageSets/train2.txt")
    val_img_ids = _read_imageset_file("./data/ImageSets/val2.txt")
    #trainval_img_ids = _read_imageset_file("./data/ImageSets/trainval.txt")
    #test_img_ids = _read_imageset_file("./data/ImageSets/test.txt")
    #test_img_ids = _read_imageset_file("./data/ImageSets/test2.txt")
...
def create_kitti_info_file3(data_path,
                           save_path=None,
                           create_trainval=False,
                           relative_path=True):
    train_img_ids = _read_imageset_file("./data/ImageSets/train3.txt")
    val_img_ids = _read_imageset_file("./data/ImageSets/val3.txt")
    #trainval_img_ids = _read_imageset_file("./data/ImageSets/trainval.txt")
    #test_img_ids = _read_imageset_file("./data/ImageSets/test.txt")
    #test_img_ids = _read_imageset_file("./data/ImageSets/test3.txt")
...
def create_kitti_info_file4(data_path,
                           save_path=None,
                           create_trainval=False,
                           relative_path=True):
    train_img_ids = _read_imageset_file("./data/ImageSets/train4.txt")
    val_img_ids = _read_imageset_file("./data/ImageSets/val4.txt")
    #trainval_img_ids = _read_imageset_file("./data/ImageSets/trainval.txt")
    #test_img_ids = _read_imageset_file("./data/ImageSets/test.txt")
    #test_img_ids = _read_imageset_file("./data/ImageSets/test4.txt")
...
def create_kitti_info_file5(data_path,
                           save_path=None,
                           create_trainval=False,
                           relative_path=True):
    train_img_ids = _read_imageset_file("./data/ImageSets/train5.txt")
    val_img_ids = _read_imageset_file("./data/ImageSets/val5.txt")
    #trainval_img_ids = _read_imageset_file("./data/ImageSets/trainval.txt")
    #test_img_ids = _read_imageset_file("./data/ImageSets/test.txt")
    #test_img_ids = _read_imageset_file("./data/ImageSets/test5.txt")
...
# def create_kitti_info_val_10m(data_path,
#                            save_path=None,
#                            relative_path=True):
...
#         relative_path=relative_path)
#     _calculate_num_points_in_gt(data_path, kitti_infos_val, relative_path)
#     filename = save_path / 'kitti_infos_val_10m-20m.pkl'
#     print(f"Kitti info val file is saved to {filename}")
#     with open(filename, 'wb') as f:
#         pickle.dump(kitti_infos_val, f)


# def create_kitti_info_val_20m(data_path,
#                            save_path=None,
#                            relative_path=True):
...
#         relative_path=relative_path)
#     _calculate_num_points_in_gt(data_path, kitti_infos_val, relative_path)
#     filename = save_path / 'kitti_infos_val_0m-20m.pkl'
#     print(f"Kitti info val file is saved to {filename}")
#     with open(filename, 'wb') as f:
#         pickle.dump(kitti_infos_val, f)


# def create_kitti_info_val_30m(data_path,
#                            save_path=None,
#                            relative_path=True):
...
#         relative_path=relative_path)
#     _calculate_num_points_in_gt(data_path, kitti_infos_val, relative_path)
#     filename = save_path / 'kitti_infos_val_30m.pkl'
#     print(f"Kitti info val file is saved to {filename}")
#     with open(filename, 'wb') as f:
#         pickle.dump(kitti_infos_val, f)

...
from second.data.preprocess import _read_and_prep_v9,_read_and_prep_velodyne
...
class evalDataset(Dataset):
    def __init__(self, points, root_path, num_point_features,
                 target_assigner, feature_map_size, prep_func):
    ...
    def __getitem__(self, idx):
        ...
        #     num_point_features=self._num_point_features,
        #     prep_func=self._prep_func)
        return _read_and_prep_velodyne(
            self.points,
            root_path=self._root_path,
            num_point_features=self._num_point_features,
            prep_func=self._prep_func)

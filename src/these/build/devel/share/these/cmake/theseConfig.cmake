...
if(these_CONFIG_INCLUDED)
  return()
endif()
set(these_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(these_SOURCE_PREFIX /home/these/catkin_ws/src/these)
  set(these_DEVEL_PREFIX /home/these/catkin_ws/src/these/build/devel)
  set(these_INSTALL_PREFIX "")
  set(these_PREFIX ${these_DEVEL_PREFIX})
else()
  set(these_SOURCE_PREFIX "")
  set(these_DEVEL_PREFIX "")
  set(these_INSTALL_PREFIX /usr/local)
  set(these_PREFIX ${these_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'these' is deprecated")
...
set(these_FOUND_CATKIN_PROJECT TRUE)
...
if(NOT "/usr/include/eigen3;/usr/include/pcl-1.8;/usr/include;/usr/include/ni;/usr/include/openni2;/usr/include/vtk-6.3;/usr/include/freetype2;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent/include;/usr/lib/x86_64-linux-gnu/openmpi/include;/usr/include/python2.7;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/libxml2;/usr/include/jsoncpp;/usr/include/tcl " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'takahiro <takahiro@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${these_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'these' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'these' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/these/catkin_ws/src/these/${idir}'.  ${_report}")
    endif()
    _list_append_unique(these_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND these_LIBRARIES ${library})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/these/catkin_ws/src/these/build/devel/lib;/home/these/catkin_ws/devel/lib;/opt/ros/melodic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(these_LIBRARY_DIRS ${lib_path})
      list(APPEND these_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'these'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND these_LIBRARIES ${lib})
    endif()
  endif()
...
set(these_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${these_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 these_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${these_dep}_FOUND)
      find_package(${these_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${these_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(these_INCLUDE_DIRS ${${these_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(these_LIBRARIES ${these_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${these_dep}_LIBRARIES})
  _list_append_deduplicate(these_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(these_LIBRARIES ${these_LIBRARIES})

  _list_append_unique(these_LIBRARY_DIRS ${${these_dep}_LIBRARY_DIRS})
  list(APPEND these_EXPORTED_TARGETS ${${these_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${these_DIR}/${extra})
  endif()
  include(${extra})
endforeach()

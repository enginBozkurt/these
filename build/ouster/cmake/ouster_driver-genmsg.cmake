...
set(MSG_I_FLAGS "-Iouster_driver:/home/these/catkin_ws/src/ouster/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg;-Isensor_msgs:/opt/ros/melodic/share/sensor_msgs/cmake/../msg;-Igeometry_msgs:/opt/ros/melodic/share/geometry_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/these/catkin_ws/src/ouster/msg/PacketMsg.msg" NAME_WE)
add_custom_target(_ouster_driver_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ouster_driver" "/home/these/catkin_ws/src/ouster/msg/PacketMsg.msg" ""
)
...
_generate_msg_cpp(ouster_driver
  "/home/these/catkin_ws/src/ouster/msg/PacketMsg.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ouster_driver)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ouster_driver\")")
  # install generated code
  install(
